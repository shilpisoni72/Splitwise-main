...
class CurrentUser extends Component{
    ...
    render(){
        return(
            ...
            {this.props.loggedIn
             ? <span>
                    <FlatButton style={{'marginLeft':'70px'}} target="_blank" onClick={this.popover.bind(this)} 
                ...
                : <span>
                    <FlatButton style={Styles.flatLogin} labelStyle={Styles.labelText}
                        hoverColor='#bdbdbd' rippleColor='#efefef' 
    ...
    render(){
        return(
            <AppBar
                ...
                iconElementRight=
                {<CurrentUser   loggedIn={this.props.loggedIn}              username={this.props.username}
